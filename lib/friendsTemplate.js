  ...
  <body>
    ...
    friendsMain: function (groupList, friendsList) {
      return `
        ...
        <div class="btn">
            <button type="button" id="setfriend" onClick="location.href='/friends/sentReq'">친구 관리</button>  
            <button type="button" id="fix">편집</button>    
      
            <button type="button" id="addfriend" style="display: none;" onClick="location.href='/friends/addFriends'">친구 추가</button>                
            <button type="button" id="addgroup" style="display: none;" onClick="location.href='/friends/addGroup'">그룹 추가</button>
        </div>      
    ...
    addFriend: function (friendsList) {
      return `
        ...
        <form method="post"  class="form" action="/friends/findFriends">
            <input type="text" name="email"  id='email' onchange='pname()' placeholder="이메일 검색"></input>        
    ...
    sentReq: function (friendsList) {
      ...
      return `
        <div class="box">
        <div class="closebox">
          <a href="/friends" class="close">x</a>
          </div>
        <div class ="set2">
    ...
    receivedReq: function (friendsList) {
      ...
      return `
        ...
        <form method="post"  class="form" action="/friends/req_process">
                <div class="setting_list">
              ...
              <span class="addd"> 
                  <input class="sendbtn"  type="submit" id="sendbtn" name="process" value= "승인" type="button" >
                  <input class="sendbtn"  type="submit" id="sendbtn" name="process" value= "거절" type="button" >
